...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "point_station_data")
@Entity
public class PointStationData {
    @Id
    @GenericGenerator(name = "point_station_data_uuid",strategy = "uuid")
    @GeneratedValue(generator = "point_station_data_uuid")
    private String id;
    ...
    @JoinColumn(name = "PS_POINT_ID")
    @ManyToOne(cascade = {CascadeType.MERGE,CascadeType.REFRESH},optional=false)
    @JsonIgnoreProperties("pointStationDataSet")
    private PointStation pointStation;
}
